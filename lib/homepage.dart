...
class _HomePageState extends State<HomePage> {
  ...
  var myScorestyle = TextStyle(color: Colors.white,fontSize: 28);
  int ohScore = 0;
  int exScore = 0;
  int filledBoxes = 0;
              ...
              itemBuilder: (BuildContext context, int index){
                return GestureDetector(
                  onTap: (){
                    ...
                    child: Center(child: Text(displayExOh[index],style: TextStyle(color: Colors.white,fontSize: 40),),),
                  ),
                );
              }),
          ),
...
void _showWinDialog(String winner){
  ...
  builder: (BuildContext context){
    return AlertDialog(
      title: Text( 'WINNER IS: '+winner.toUpperCase(),style: myNewFont,),
      actions: <Widget>[
        FlatButton(child: Text('Play Again',style: myNewFont,),
        onPressed:(){
          _clearBoard();
